...
public class C1_Scanner {
	...
	public static void main(String[] args) {
		...
		// new : Java da ne zaman new kelimesini gorseni yeni bir object olusturuluyor
		// demektir
		// parantezin icine yazilan degerlere parametre diyoruz ve Scanner icin
		// System.in yazmamiz gerekir
		// Bir kod yazdigimizda kodun altinda kirmizi cizgi olusuyorsa veya satir
		// numarasi
		...
		// oldugunda ihtiyacimiz olan kodlari
		// class'a import etmemiz yeterlidir
		// scan olusturdugumuz Scanner objesine verdigimiz isimdir. farkli isimler de
		// verebiliriz
		// ancak scan ismi tum programcilar tarafindan kullanilan bir isimdir
		// kodumuzun anlasilabilir ve rahat okunabiilir olmasi icin scan ismini
		...
		// girebilir,
		// buyuk bir sayi da yazabilir, tam sayi da yazabilir, virgullu sayi da
		// yazabilir
